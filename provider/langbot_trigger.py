...
class LangbotTriggerTrigger(Trigger):
    """
...
class LangbotTriggerSubscriptionConstructor(TriggerSubscriptionConstructor):
    """Manage langbot_trigger trigger subscriptions."""
