...
class BotGroupMessageEvent(Event):
    """
    ...
    def _on_event(self, request: Request, parameters: Mapping[str, Any], payload: Mapping[str, Any]) -> Variables:
        ...
        print("bot_group_message payload: ", payload)
        ...
        return Variables(
            variables={
                ...
                "group_id": payload.get("data", {}).get("group", {}).get("id", ""),
                "group_name": payload.get("data", {}).get("group", {}).get("name", ""),
